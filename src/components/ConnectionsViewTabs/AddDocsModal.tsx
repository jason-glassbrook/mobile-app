...
useEffect(() => {
  axios
    .post("https://family-staging.connectourkids.org/api/v1/documents/")
    .then(
      res => {
        console.log(res);
      },
...
function NotesForm(Notes: string): void {
  axios
    .post(
      `https://family-staging.connectourkids.org/api/v1/person/${pk}/histories/`
    )
    .then(
      res => {
        console.log(res);
