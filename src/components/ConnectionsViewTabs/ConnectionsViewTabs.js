  ...
  return (
    <View style={{ flexDirection: 'row', alignItems: "flex-start", justifyContent: "flex-start", marginBottom:20 }}>
      <Avatar
        ...
        rounded />
      <View>
  <Text style={{fontSize: 16}}>{props.engagement.created_by.full_name} {getDataIcon()} {props.engagement.data_type === 'R' ? props.engagement.due_date.substring(0, 10) : null}</Text>
